# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-09-11 10:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevie', '存储设备'), ('securitydevice', '安全设备'), ('software', '软件资产')], default='server', max_length=64, verbose_name='资产类型')),
                ...
                ('status', models.SmallIntegerField(choices=[(0, '在线'), (1, '下线'), (2, '位置'), (3, '故障'), (4, '备用')], default=0, verbose_name='设备状态')),
                ...
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin', to=settings.AUTH_USER_MODEL, verbose_name='管理员')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license', models.IntegerField(blank=True, null=True, verbose_name='license数量')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(blank=True, max_length=30, null=True, verbose_name='支持热线')),
                ('memo', models.CharField(blank=True, max_length=128, null=True, verbose_name='备注')),
            ],
            options={
                'verbose_name': '厂商',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip_add', models.GenericIPAddressField(blank=True, null=True, verbose_name='IP地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.SmallIntegerField(choices=[(0, 'PC服务器'), (1, '刀片型'), (2, '小型机')], default=0, verbose_name='服务器类型')),
                ('created_by', models.CharField(choices=[('auto', '自动添加'), ('manual', '手动录入')], default='auto', max_length=32, verbose_name='添加方式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_aset_type', models.SmallIntegerField(choices=[(0, '磁盘阵列'), (1, '网络存储器'), (2, '磁带库'), (3, '磁带机')], default=0, verbose_name='存储类型')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '存储设备',
