...
class Asset(models.Model):
    ...
    admin = models.ForeignKey(User, null=True, blank=True, verbose_name='管理员', related_name='admin')
...
class Manufacturer(models.Model):
    ...
    telephone = models.CharField('支持热线', max_length=30, blank=True, null=True)
...
class Contract(models.Model):
    ...
    license = models.IntegerField('license数量', blank=True, null=True)
...
class NIC(models.Model):
    ...
    class Meta:
        ...
        unique_together = ('asset', 'model', 'mac')    # 资产、型号和mac必须联合唯一，防止虚拟机中特殊情况发生错误
